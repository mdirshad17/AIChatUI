...
export default function Login() {
  ...
  window.location.href = 'http://3.108.194.133.nip.io:8080/oauth2/authorization/google';
};

const handleGithubLogin = () => {
  window.location.href = 'http://3.108.194.133.nip.io:8080/oauth2/authorization/github';
};
